...
Watched classes in Lecture 32 - Lab 09:
* Word.kt
* WordDao.kt
* WordRoomDatabase.kt (only line 32)

Contains the finished sample code for the
[Architecture Components Kotlin codelab](https://codelabs.developers.google.com/codelabs/android-room-with-a-view-kotlin).
The original code can be found in the Kotlin branch of the
[android-room-with-a-view](https://github.com/googlecodelabs/android-room-with-a-view/) repository
as of commit 0d72896.
